import { StarUpSlide } from '@components/KeyFrames';
import styled, { css } from 'styled-components';

export const CommonStar = css`
  content: ' ';
  position: absolute;
...
export const StarFirst = styled.div`
  ${CommonStar}
  width: 3px;
  height: 3px;
  animation: ${StarUpSlide} 150s linear alternate infinite;
`;
...
export const StarSecond = styled.div`
  ...
  width: 3px;
  height: 3px;
  animation: ${StarUpSlide} 30s linear alternate infinite;
`;

export const StarThird = styled.div`
  ${CommonStar}
  width: 2px;
  height: 2px;
  animation: ${StarUpSlide} 50s linear alternate infinite;
`;

export const StarFourth = styled.div`
  ${CommonStar}
  width: 1px;
  height: 1px;
  animation: ${StarUpSlide} 80s linear alternate infinite;
`;
